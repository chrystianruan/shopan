...
<div class="container">
    <div class="wrapper">
      ...
      <form action="/admin/edit/product/{{ $product->id }}" method="POST" enctype="multipart/form-data">
       @method('PUT')
       @csrf
        <img width=200 src="{{ url('storage/'.$product->image) }}">
        <div class="row">
        ...
        <div class="row">
          ...
          <input type="number" name="price" min="0" step="0.01" placeholder="Digite o valor do produto" required value="{{$product->price}}">
        </div>
